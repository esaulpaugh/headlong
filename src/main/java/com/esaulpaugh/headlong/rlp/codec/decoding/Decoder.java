...
public class Decoder {
    ...
    public static List<Object> decodeRLP(byte[] encoding) {
        return decodeRLP(encoding, 0, encoding.length);
    }

    private static List<Object> decodeRLP(byte[] encoding, int index, int len) {
    ...
    private static int buildLongList(final byte[] data, int i, int end, final List<Object> parent) {
...
//            default:
    ...
    private static int buildShortList(List<Object> parent, final byte[] data, final int dataIndex, final int end) {
    ...
    private static int buildString(List<Object> objects, byte[] data, int from, int to) {
