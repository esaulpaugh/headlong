...
public class Strings {
    ...
    public static String toBase64(byte[] bytes, int from, int len, boolean withPadding) {
        ...
        return Base64.encodeBytes(bytes, from, len, options);
    }
    ...
    public static byte[] fromBase64(String base64, boolean hasPadding) {
        ...
        final int options = hasPadding ? Base64.NO_OPTIONS : Base64.NO_PADDING;
        try {
            return Base64.decode(base64, options);
...
//    }
//
//    static String unpadBase64(byte[] padded) { // ascii bytes
...
//    }
//
//    static byte[] padBase64(String unpadded) {
