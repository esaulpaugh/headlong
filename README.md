...
[![Apache License, Version 2.0, January 2004](https://img.shields.io/github/license/apache/maven.svg)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
#### Bug Advisory: https://github.com/esaulpaugh/headlong/discussions/78
...
SHA-256 (headlong-13.3.1.jar): 359e41ed56cbc04ae1bb0071f8615d2a2457ac49c6bc3926a450bd819cd679d8
...
headlong depends on gson v2.1 or greater at runtime and on v2.12.0 or greater at compile time. Test suite should take less than one minute to run. Test packages require junit. Jar size is ~137 KiB. Java 8+.
