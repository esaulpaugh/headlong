...
SHA-256 (headlong-5.1.0.jar): 8c631fa21a85e6a94e3a88b93f78dd88b9ae151c78ac5d5abb4537da140ccddd
...
```groovy
implementation 'com.esaulpaugh:headlong:5.1.1-SNAPSHOT'
```
...
headlong (optionally) depends on gson. Test suite should take less than one minute to run. Test packages require junit. Jar size is ~120 KiB. Java 8+.
